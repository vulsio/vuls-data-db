...
# Held back until nightly has run it. Uncomment to add it here too.
#	$(MAKE) -f ${MAKEFILE} db-add REPO=vuls-data-extracted-apple-security-releases BRANCH=${BRANCH} DBTYPE=${DBTYPE} DBPATH=${DBPATH}
